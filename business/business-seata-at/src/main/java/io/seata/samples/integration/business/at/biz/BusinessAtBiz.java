package io.seata.samples.integration.business.at.biz;
...
public class BusinessAtBiz {
     ...
     * 处理业务逻辑 正常的业务逻辑
     */
    @GlobalTransactional(timeoutMills = 300000, name = "gts-business-seata-at")
    public ResponseVO<Object> handleBusiness(BusinessParam param) {
        ...
        ResponseCodeMsg stockRsp = stockService.decreaseStock(stockParam);
        // 2、创建订单
        ...
        ResponseCodeMsg orderRsp = orderService.createOrder(orderParam);
